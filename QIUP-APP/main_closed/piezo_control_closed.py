...
class PiezoController:
    ...
    def move_to_um(self, position_um: float) -> bool:
        ...
        Clamped to [0.0, MAX_TRAVEL_UM]. No artificial blocking is used so that
        fast phase scans are not throttled by the 250ms USB polling lag.
